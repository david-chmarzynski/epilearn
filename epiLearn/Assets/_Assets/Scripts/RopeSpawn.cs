...
public class RopeSpawn : MonoBehaviour
{
    ...
    public void Spawn()
    {
        ...
        for(int x = 0; x < count; x++)
        {
            ...
            tmp = Instantiate(partPrefab, new Vector3(transform.localPosition.x, transform.localPosition.y * partDistance * (x + 1), transform.localPosition.z), Quaternion.identity, parentObject.transform);
